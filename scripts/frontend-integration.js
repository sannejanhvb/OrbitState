 ...
 * This file demonstrates how to integrate Orbitstate with a web frontend
 */

// For React/Vue/Angular applications
export class OrbitstateClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OrbitstateClient(provider, contractAddress);
